...
const PRICES = [
  { name: "Terapevtik ko'rik / konsultatsiya", price: "50 000" },
  { name: "Tish tozalash (gigiyena)", price: "300 000" },
  { name: "Kariyes davolash (plomba)", price: "250 000 dan" },
  { name: "Tish olish (oddiy)", price: "150 000 dan" },
  { name: "Kanal davolash", price: "600 000 dan" },
  { name: "Metall brekket (bir jag')", price: "3 500 000" },
  { name: "Keramik brekket (bir jag')", price: "5 500 000" },
  { name: "Shaffof kappa", price: "8 000 000 dan" },
  { name: "Implant o'rnatish", price: "4 000 000 dan" },
];
// ------------------------------------------------------------
...
function priceListText(){
  const rows = PRICES.map(p => `• ${p.name} — <b>${p.price}</b> so'm`).join("\n");
